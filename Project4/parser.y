...
ClassDeclaration	: IDENTIFIER OPENBRACKET Members Methods CLOSEBRACKET {$$.class_ptr = new ClassNode(new IdentifierNode($1.base_char_ptr), NULL, $3.declaration_list_ptr, $4.method_list_ptr);}
...
Type			: BOOLEAN {$$.type_ptr = new BooleanTypeNode();}
			| INTEGER	  {$$.type_ptr = new IntegerTypeNode();}
			| IDENTIFIER  {$$.type_ptr = new ObjectTypeNode(new IdentifierNode($1.base_char_ptr));}
			| NONE		  {$$.type_ptr = new NoneNode();}
			;
